...
{
    public partial class VaccineUserControl : UserControlBase, IVaccineUser
    {
        #region Members
        private readonly VaccineUserPresenter _vaccineUserPresenter;
        ...
        #region Constructor
        public VaccineUserControl()
        {
            InitializeComponent();
            _vaccineUserPresenter = new VaccineUserPresenter(this, this);
        ...
        public bool IsActiveCreateVaccine
        {
            get => BtnCreateVaccine.Enabled;
            set => BtnCreateVaccine.Enabled = value;
        }
        ...
        public void ResetControls() 
        {
            ...
            {
                if (c is VaccineSellUserControl || c is VaccineCreateUserControl)
                    controls.Add(c);
            }
        ...
        private void gvOrderList_SelectionChanged(object sender, EventArgs e)
        {
            ...
            if (selectedEntries?.Count == 1)
            {
                ...
                IsActiveSellVaccine = string.Equals(SelectedVaccineEntry.OrderStatus, "accepted", StringComparison.InvariantCultureIgnoreCase);
        ...
        {
            var vaccineSellUserControl = new VaccineSellUserControl(Patient, SelectedVaccineEntry);
        ...
        private void BtnCreateVaccine_Click(object sender, EventArgs e)
        {
            var vaccineCreateUserControl = new VaccineCreateUserControl(Patient, LowIncome);
            vaccineCreateUserControl.CloseEvent += VaccineUserControlOnCloseEvent;
            ChangePanel(vaccineCreateUserControl);
        }
