...
namespace POS_display
{
    public partial class doctor : Form
    {
        ...
        #region Callbacks
        private void dbDoctor(bool success, DataTable t)
        {
        ...
        private void dbAutocompleteName(bool success, DataTable t)
        {
            ...
            this.Invoke(new MethodInvoker(delegate
            {
                ...
                DB.POS.asyncAutocomplete("doctor", "code", dbAutocompleteCode);
            }));
        }
        ...
        private void dbAutocompleteCode(bool success, DataTable t)
        {
            ...
            this.Invoke(new MethodInvoker(delegate
            {
                ...
                {
                    tbFilter.Text = "";
                    DB.recipe.asyncDoctor(((KeyValuePair<string, string>)ddFilter.SelectedItem).Key, tbFilter.Text, dbDoctor);
                }
                else
                    form_wait(false);
            }));
...
#pragma warning restore CS4014 // Because this call is not awaited, execution of the current method continues before the call is completed
            ...
            test.Add("code:name", "Kodą, vardą ir pavardę");
            test.Add("code", "Kodą");
            test.Add("name", "Vardą ir pavardę");
            ...
            if (allCol.Count == 0)
                DB.POS.asyncAutocomplete("doctor", "name", dbAutocompleteName);
            else
            {
                BindGrid();
                autocomplete_source();
        ...
        private void doctor_Closing(object sender, FormClosingEventArgs e)
        {
        ...
        private void GridView_order()
        {
            ...
            gvFilter.Columns["name"].HeaderText = "Gydytojas";
        ...
        private void gvFilter_DoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (e.RowIndex < 0)
                return;
            dCode = gvFilter.Rows[e.RowIndex].Cells["code"].Value.ToString();
            dName = gvFilter.Rows[e.RowIndex].Cells["name"].Value.ToString();
        ...
        private void autocomplete_source()
        {
            ...
            if (((KeyValuePair<string, string>)ddFilter.SelectedItem).Key.Equals("code:name"))
