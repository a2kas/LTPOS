...
{
    public partial class ucRecipeEdit : ucRecipeEditBase, IRecipeEdit
    {
        //hidden variables
        ...
        #endregion
        public ucRecipeEdit(Items.eRecipe.Recipe erecipe_item, Items.posd posd_item, string PickedUpByRef = "")
        {
            InitializeComponent();
...
#pragma warning restore CS4014 // Because this call is not awaited, execution of the current method continues before the call is completed
                ...
                if (hd_recipeId == 0)//new recipe
                {
                    ...
                    {
                        //DataTable temp = null;
                        //using (var tsk = DB.recipe.getTLKPrice(hd_productId, "100", DateTime.Now))
                        //    temp = tsk.Result;
                        //if (temp != null && temp.Rows.Count > 0)
                        //{
        ...
        private async void btnSave_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                Serilogger.GetLogger().Information($"{RecipeNo} recipe is being saved! Composition ID: {in_erecipe?.CompositionId}");
                ...
                if (E_Recipe && in_erecipe != null)
                {
                    ...
                    if (success)
                    {
                        ...
                        btnSave.Enabled = false;//kad nebeleistu antra kart save spaust
                    }
        ...
        private decimal HiddenQtyDay { get; set; } = 1;
